...
CORS_ALLOW_CREDENTIALS = True  # Necessary since your backend uses session login
...
ROOT_URLCONF = 'agent_fights.urls'
...
WSGI_APPLICATION = 'agent_fights.wsgi.application'
